    ...
    <BaseLayout>
      <section className="mt-20 lg:flex justify-around items-center">
        <div>
          ...
          <p className="lg:w-[560px] pt-5">
            Farm Trust Finance (FTF) is a Neo Banking platform that offers
            banking services to smallholder farmers through providing services
            like Prometric insurance, lending, borrowing, cross-chain asset
      ...
      <section className="mt-40 lg:flex justify-around items-center">
        ...
        <div className="pl-5">
          ...
          <h1 className="font-bold text-[20px] py-4">Prometric Insurance</h1>
