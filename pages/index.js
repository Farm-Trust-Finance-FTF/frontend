...
export default function Home() {
  return (
    <BaseLayout>
      <section className='mt-20 lg:flex justify-between items-center'>
        <div>
        ...
        <img className='w-[400px] m-auto mt-5' src='/img/hero.png' />
      </section>

      <section className='mt-40 lg:flex justify-between items-center'>
        <div>
        ...
        <img className='w-[400px] m-auto mt-5' src='/img/what.png' />
      </section>
      ...
      <section className='mt-40 lg:flex justify-between items-center'>
        ...
        <img className='w-[400px] m-auto mt-5' src='/img/why.png' />
      </section>

      <section className='mt-40 lg:flex justify-between items-center'>
        <img className='w-[400px] m-auto mt-5' src='/img/insure.png' />
        <div className='pl-5'>
          {/* <h1 className='font-bold text-[18px] text-[#446119]'>
          Why Farm Trust Finance (FTF)
          </h1> */}
